...
export default async function WinnersPage() {
  const completedDraws: CompletedDrawWithWinner[] = await prisma.draw.findMany({
  ...
  const winningTokens: (Token | null)[] = await Promise.all(
    completedDraws.map(async (draw: CompletedDrawWithWinner) => {
